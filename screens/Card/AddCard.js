...
const AddCard = ({ navigation, route }) => {
    ...
    const [cardNumber, setCardNumer] = React.useState("")
    const [cardNumberError, setCardNumerError] = React.useState("")
        ...
        return(
            ...
            >
                ...
                <FormInput
                    ...
                    value={cardNumber}
                    onChange={(value) => {
                        setCardNumer(value.replace(/\s/g, '').replace(/(\d{4})/g, '$1 ').trim())  //regular Expresion

                        utils.validateInput(value, 19, setCardNumerError)
                    }}
